        ...
        <div class="col-md-4">
            <div class="gall_block">
                <div class="maxheight">
                    ...
                    <a href="{{route( 'dishes.index', ['alias' => $item->alias])}}" class="gall_item"><img src="{{asset(env('THEME'))}}/images/page2_img1.jpg" alt="" ></a>

                    <div class="gall_bot">
                        <div class="text1">
                            <a href="{{route( 'dishes.index', ['alias' => $item->alias])}}">{{$item->title}} </a>
                        </div>
